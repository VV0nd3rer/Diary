...
public class PaginationServiceImpl implements PaginationService {
	...
	@Override
	public Pagination getPaginatedPage(int page_index, String pagination_type) {
...
/*		switch (pagination_type) {
		...
		int numOfPosts = pageDao.getNumOfPosts();
		...
		List<Post> pagePosts = pageDao.getLimitPosts(num_posts_on_page, posts_row_offset);
